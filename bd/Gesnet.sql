...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2018 a las 18:49:56
...
CREATE  PROCEDURE `sp_imprimir_ticket` (IN `p_idventa` INT(11))  BEGIN
		...
		SET p_cliente = (SELECT  cliente.nombre_cliente FROM cliente JOIN venta ON cliente.idcliente = venta.idcliente WHERE idventa=p_idventa );
...
(1, 'EM00000001', 'EMPLEADO', 'TIENDA', '985444754', 'tienda@empresa.com', 1);
...
(1, '2017-11-28 10:56:11', '20172811', '14541474584', 1, 5000, 1, 4999),
(2, '2017-11-28 10:56:11', '1214584575', '11545887965', 1, 5000, 2, 4999),
