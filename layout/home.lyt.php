...
<head>
	...
	<meta name="description" content="SOFTMASTER es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
	<title>SOFTMASTER - Facturación e Inventario</title>
	...
	<link rel="icon" type="image/png" href="web/assets/images/ct.ico"/>
	<link rel="shortcut icon" href="web/assets/images/ct.ico">
	<!-- /global stylesheets -->
...
<body class="sidebar-xs has-detached-right">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="./?View=Inicio">SOFTMASTER <!--<img src="web/assets/images/logo_gesnet.png" alt="">--></a>
