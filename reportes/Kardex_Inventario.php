...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1) {
            ...
            $ano = is_numeric($mes) ? substr($mes, 3, 4) : ''; // Verifica si $mes es numérico antes de usar substr
            ...
            $this->Cell(100);
            // Title
            $this->Cell(105, 10, 'RESUMEN DE SALDOS Y MOVIMIENTOS DE PRODUCTOS DEL MES DE '  . strtoupper($meses[(int) date("m", strtotime($mes)) - 1] . ' del ' . $ano), 0, 0, 'C');
