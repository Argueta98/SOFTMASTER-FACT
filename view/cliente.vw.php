				...
				<div id="modal_iconified" class="modal fade">
					<div class="modal-dialog">
						<div class="modal-content">
						           ...
						           <div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												<label>DUI</label>
												<input type="text" id="txtNIT" name="txtNIT" placeholder="EJ. 00000000-0"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												<label>Email</label>
												<input type="email" id="txtEmail" name="txtEmail" placeholder="EJ. empresa@gmail.com"
												 class="form-control">
											</div>
										</div>
									</div>
                           ...
                           placeholder="EJ. SAN FRANCISCO GOTERA, MORAZAN"
