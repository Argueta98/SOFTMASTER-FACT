		...
		<form autocomplete="off" action="" class="form-validate">
			<div class="panel panel-body login-form">
				<div class="text-center">
					<img width="175" height="93"  src="./web/assets/images/logoo1.png">
					<h5 class="content-group">Bienvenido a SoftMaster<small class="display-block">Iniciar Sesión</small></h5>
				</div>
